...
@keyframes profile{
  0%{
    ...
    100%{
      border-color: rgb(150,55,205);
      box-shadow: 10px 10px 100px 50px rgb(150,55,205);
      transform: translate(0, 0px);
...
export const ResumeButton = styled.a`
    ...
    background: -webkit-linear-gradient(225deg, hsl(201.6deg 72.62% 47.07%) 0%, hsl(49.85deg 100% 50% / 94%) 100%);
